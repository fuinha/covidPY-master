      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            SizedBox(height: 10),
            CustomText(text: "Casi ahí!", size: 28, weight: FontWeight.bold),
            SizedBox(height: 5),
            RichText(
                text: TextSpan(children: [
                  TextSpan(text: "Solo tienes que agregar tu"),
                  TextSpan(text: " Bluetooth", style: TextStyle(color: Colors.blue.shade900)),
                  TextSpan(text: " habla a"),
                ], style: TextStyle(color: black))),
            SizedBox(height: 10),
            SizedBox(height: 5),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text("Lamentamos el trabajo extra ;) \n Encuentra la dirección en \n SETTINGS > ABOUT PHONE > STATUS", textAlign: TextAlign.center, style: TextStyle(color: grey),),
            ),
            Padding(
...
//                    keyboardType: TextInputType.phone,
            ...
            SizedBox(height: 10),
            CustomButton(msg: "Enviar Dirección", onTap: (){
